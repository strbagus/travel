...
<template>
  <NuxtLayout name="main">
    ...
    <div class="max-w-[1000px] mx-auto px-3 py-12">
      <h2 class="text-center text-purple-700 text-3xl font-medium">Destination Highlight</h2>
          ...
          <div v-for="view in views" class="px-4 py-2 w-full md:w-1/3 group">
            <NuxtLink :to="`/destination/destination-${view.name}`">
              <div class="relative w-full aspect-[3/4]">
                <img src="/assets/dummy-md.jpg" loading="lazy"
                  class="absolute rounded-r-xl rounded-bl-xl object-cover h-full w-full left-0 right-0">
                <div class="opacity-90 h-full text-white flex flex-col justify-end">
                  <div class="bg-black bg-opacity-0 group-hover:bg-opacity-10 h-full duration-200"></div>
                  <div
